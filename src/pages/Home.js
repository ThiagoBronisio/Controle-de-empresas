    ...
    <>
                ...
                <div className="card shadow mt-5 rounded-0 p-3" style={{ marginBottom: "50px" }}>
                    <div className="card-body px-2 p-3">
                        <div className="text-start px-4">
                            ...
                            <p className="mt-3" style={{ fontSize: "1.9em", fontWeight: "300" }}>Informe seu usuario:</p>
                        </div>
                        <HomeForms />
                    </div>
                </div>
        ...
        <section>
            <div className="container">
                <h1 style={{ borderBottom: "3px solid #ffc709", marginTop:"100px" }} className="text-start">Ambiente Empresarial </h1>
            </div>
            ...
            <div className="row justify-content-center container d-flex" style={{ marginLeft: "auto", marginRight:"auto" }}>
                    ...
                    <div className="card text-secondary shadow mt-5">
                        <div className="card-body px-2 p-3">
                            <div className="text-center px-4 mt-3 fw-bold">
                                <span><i style={{ fontSize: "80px" }} className="fas fa-chart-pie text-dark"></i></span>
                ...
                <div className="col-4">
                    <div className="card text-secondary shadow mt-5">
                        <div className="card-body px-2 p-3">
                            <div className="text-center px-4 mt-3 fw-bold">
                                <span><i style={{ fontSize: "80px" }} className="fas fa-building text-dark"></i> <i style={{ fontSize: "25px" }} className="fas fa-search text-secondary"></i></span>
                ...
                <div className="col-4">
                    <div className="card text-secondary shadow mt-5">
                        <div className="card-body px-2 p-3">
                            <div className="text-center px-4 mt-3 fw-bold">
                                <span><i style={{ fontSize: "80px" }} className="fas fa-building text-dark"></i> <i style={{ fontSize: "25px" }} className="fas fa-plus text-secondary"></i></span>
